 ...
 * AddTodo reducer
 */
export const addTodoReducer = (state: ITodo[], action: IAction<ITodo>) => {
 ...
 */
export const addBatchTodoReducer = (state: ITodo[], action: IAction<ITodo[]>) => {
 ...
 */
export const removeTodoReducer = (state: ITodo[], action: IAction<number>) => {
 ...
 * RemoveAll reducer
 */
export const removeAllReducer = (state: ITodo[], action: IAction) => {
    return [];
};
 ...
 * ToggleMyDay reducer
 */
export const toggleMyDayReducer = (state: ITodo[], action: IAction<number>) => {
    const oldState = state!;
 ...
 */
export const toggleCompletedReducer = (state: ITodo[], action: IAction<number>) => {
    const oldState = state!;
 ...
 */
export const setShowCompletedReducer = (state: ITodoAppSettings, action: IAction<boolean>) => {
 ...
 */
export const setMyDayOnlyReducer = (state: ITodoAppSettings, action: IAction<boolean>) => {
